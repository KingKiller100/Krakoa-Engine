...
namespace krakoa::configurations
{
	...
	public:
		...
		void Set( const std::string& context, const std::string& key, const T& value, const klib::MutSourceInfo& source )
		{
			...
			LogNewConfiguration( context, key, valueStr, source );
		}
	...
	private:
		...
		void LogNewConfiguration( std::string_view context, std::string_view key, std::string_view value, const klib::MutSourceInfo& sourceInfo );
