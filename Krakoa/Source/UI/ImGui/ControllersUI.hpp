...
namespace krakoa {
	...
	namespace ui
	{
		...
		bool DrawColourController(std::string_view label, gfx::Colour& value, float columnWidth = 100.f);
		bool DrawColourController(std::string_view label, gfx::Colour& value, const gfx::Font& font, float columnWidth = 100.f);
	}
}
