...
namespace krakoa::graphics
{
	...
	public:
		...
		static void DrawTriangle(const kmaths::Vector4f& colour, const kmaths::Vector2f& position, const kmaths::Vector2f& scale = kmaths::Vector2f(1.f), const float degreesOfRotation = 0.f);
		static void DrawTriangle(const kmaths::Vector4f& colour, const kmaths::Vector3f& position, const kmaths::Vector3f& scale = kmaths::Vector3f(1.f), const float degreesOfRotation = 0.f);
