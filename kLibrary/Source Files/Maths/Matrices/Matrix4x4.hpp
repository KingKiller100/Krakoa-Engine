...
namespace kMaths
{
	...
	public:
		...
		explicit constexpr Matrix4x4(const std::array<Vector4f, 4>& newIndices) noexcept
			: indices(newIndices)
		{}
		...
		Matrix4x4 operator*(Matrix4x4& other) noexcept
		{
			auto m1 = Vector4f(other.indices[0][minorIdx1], other.indices[0][minorIdx2], other.indices[0][minorIdx3], other.indices[0][minorIdx4]);
			auto m2 = Vector4f(other.indices[1][minorIdx1], other.indices[1][minorIdx2], other.indices[1][minorIdx3], other.indices[1][minorIdx4]);
			auto m3 = Vector4f(other.indices[2][minorIdx1], other.indices[2][minorIdx2], other.indices[2][minorIdx3], other.indices[2][minorIdx4]);
			auto m4 = Vector4f(other.indices[3][minorIdx1], other.indices[3][minorIdx2], other.indices[3][minorIdx3], other.indices[3][minorIdx4]);
		...
		{
			const auto res1 = Vector4f(indices[0][0] * scalar, indices[0][1] * scalar, indices[0][2] * scalar, indices[0][3] * scalar);
			const auto res2 = Vector4f(indices[1][0] * scalar, indices[1][1] * scalar, indices[1][2] * scalar, indices[1][3] * scalar);
			const auto res3 = Vector4f(indices[2][0] * scalar, indices[2][1] * scalar, indices[2][2] * scalar, indices[2][3] * scalar);
			const auto res4 = Vector4f(indices[3][0] * scalar, indices[3][1] * scalar, indices[3][2] * scalar, indices[3][3] * scalar);
